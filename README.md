...
![alt text](/serverless_dictionary/screenshots/image.png)

# Testaus

AWS -konsolissa on myös simppeli tapa testata funktiota. Konsolissa luodaan uusi testitapahtuma, mihin annetaan JSON-muodossa pyyntö. Testin voi tallentaa myös myöhempää käyttöä varten ja ajaa konsolin sisällä, milloin testi palauttaa funktion lopputuloksen. 

![alt text](/serverless_dictionary/screenshots/image-1.png)

Testin tulos:

![alt text](/serverless_dictionary/screenshots/image-2.png)

URL:in kutsuminen selaimessa: 

![alt text](/serverless_dictionary/screenshots/image-3.png)
